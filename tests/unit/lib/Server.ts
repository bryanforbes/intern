...
import { mockNodeExecutor, MockExecutor, MockRequest, MockResponse, EventHandler } from '../../support/unit/mocks';
...
registerSuite('lib/Server', function () {
	...
	function mockMiddleware(error = false) {
		...
		const wrapper = error ? function (this: any, _: any, __: any, ___: any, ____: any) {
